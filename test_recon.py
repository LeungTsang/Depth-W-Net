...
def test_simple(args):
    ...
    depth_decoder = networks.UNet_d(args.K,3)
    ...
    if os.path.isfile(args.image_path):
        ...
        output_directory = os.path.dirname(args.image_path)+'/'+args.model_name
    ...
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            disp_resized_np = disp_resized_np.transpose(1,2,0)

            colormapped_im = (disp_resized_np * 255).astype(np.uint8)
